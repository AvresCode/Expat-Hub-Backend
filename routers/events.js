...
// post a new image
//   get token : http --ignore-stdin POST :4000/auth/login email="neda@neda.com" password="neda"
//http --ignore-stdin POST :4000/events/1/images imageUrl="https://images.unsplash.com/photo-1641816983527-51a97eff6858?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"  authorization:"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImlhdCI6MTY2MjkyOTUxMCwiZXhwIjoxNjYyOTM2NzEwfQ.YVSKqVN_yXNOEugssSO-MxwuxxgMlp_XjHHS2nAKpPs"

router.post("/:eventId/images", authMiddleware, async (req, res, next) => {
  try {
