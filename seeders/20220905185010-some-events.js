  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          title: 'Bailley Exhibition in Lakenhal Museum!',
          description:
            'Lets enjoy the sunny day this Sunday and share our beautiful pictures in Leiden by Museum de Lakenhal. The Master painter David Bailley exhibits the concepts of Time, Vanity, and Death. Later we can all have lunch, or a drink in the city of Leiden.',
          date: '2024-11-25 20:00:00',
          city: 'Leiden',
          address: 'Oude Singel 32, 2312 RA Leiden',
          spots: 10,
          imageUrl:
            'http://res.cloudinary.com/delvoxvyc/image/upload/v1684607535/test_upload/pl7gktj8wlvthnrv7dwy.jpg',
          userId: 7,
          categoryId: 4,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        {
          title: 'Kayaking in Rotterdam Centrum!',
          description:
            'A short paddle from Kralingse Plas to Rotterdam City Center, where we will visit the Saturday market and eat fish and fries!',
          date: '2024-10-09 12:00:00',
          city: 'Rotterdam',
          address: 'Kralingse Plaslaan 133, 3062 CD Rotterdam',
          spots: 8,
          imageUrl:
            'http://res.cloudinary.com/delvoxvyc/image/upload/v1684608791/test_upload/ehaj848wyujvd21ri10s.jpg',
          userId: 5,
          categoryId: 1,
          createdAt: new Date(),
          updatedAt: new Date(),
